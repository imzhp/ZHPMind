...
- 蒸馏溯源：经历史草稿 `amazon-cross-source-diff-draft.md`（v0.9.16，已随旧草稿目录退役，见 git history）跨源对照后提炼，云飞扬层为第 2 源；9.3 搜索流量 30% 口径冲突已在本页 footnote 标注（2026-05-27）。蒸馏模型 Claude Opus 4.7，2026-05-28
