--- design-principles.md	2026-05-22 18:29:54
+++ .tmp-claude-reports/incoming-v2.5/design-principles-v2.5.md	2026-05-23 11:58:50
@@ -8,7 +8,7 @@
...
+| `wiki/CLAUDE.md` | 800 行 | 同上原则;含 spec 表、Lint 清单,limit 较宽 |
